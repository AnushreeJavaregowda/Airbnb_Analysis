...
st.set_page_config(
    page_title="AirBnb-Analysis by ANUSHREE J!!!",
    page_icon=":bar_chart:",
    layout="wide"
)
...
if SELECT == "Explore Data":
    ...
    if fl is not None:
        ...
        os.chdir(r"D:\GUVI_PROJECT\Airbnb_Analysis")
...
if SELECT == "Contact":
    Name = (f'{":red[Name] :"}  {":blue[ANUSHREE J]"}')
    mail = (f'{":red[Mail] :"}  {"anugowda2023@gmail.com"}')
    description = (f'{":red[Description] :"}  {":blue[An Aspiring DATA-SCIENTIST..!]"}')
    social_media = (f'{":red[Social Media] : Hi Welcome, Connect with me on"}  {"GITHUB: https://github.com/AnushreeJavaregowda LINKEDIN: https://www.linkedin.com/in/anushree-javaregowda/"}')
        #"GITHUB": "https://github.com/AnushreeJavaregowda",
        #"LINKEDIN": "https://www.linkedin.com/in/anushree-javaregowda/"
